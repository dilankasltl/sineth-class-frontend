...
export default function AuthPage({ onLoginSuccess }) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      setSuccessMsg(
        `Registration successful! Your Student ID is ${res.data.student.studentId}. Auto-logging in...`
      );
      ...
      >
        ...
        {activeTab === 'register' && (
          ...
          >
            ...
            >
              🤖 <strong>Auto Student ID Preview:</strong>{' '}
              {regAlYear}XXXX
              <br />
              (Format: {regAlYear}0001)
            </div>
